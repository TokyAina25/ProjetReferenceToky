...
<body>
        ...
        <%@include file="includeManager/menu.jsp" %>
        ...
        <%
                       try{
                            ...
                            if(request.getParameter("contenue") == null){ %>
                             <jsp:include page="pagesManager/default.jsp" flush = 'true'></jsp:include>
                         <% }if(contenue != null){
                         %>
                        <jsp:include page='<%="pagesManager/content-" + contenue %>' />
